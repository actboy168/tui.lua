...
function suite:test_same_style_merge()
    ...
    screen_c.diff(s)  -- commit neutral frame
...
function suite:test_screen_size()
    local s = screen_c.new(30, 10)
    local w, h = screen_c.size(s)
